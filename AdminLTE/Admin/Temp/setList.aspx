            ...
            <table  class="table" style="border: 1px solid #ddd;text-align:right">
                <tbody>
                    ...
                    <tr>
                        <td>
                            <div class="form-group">
                                <label for="TSQL" class="col-sm-3 control-label">TSQL：</label>
                                <div class="col-sm-9">
                                    <textarea  name="TSQL" class="form-control" placeholder="TSQL" rows="3" ><%=tableInfo.Rows[0]["TSQL"].ToString()%></textarea>
                                </div>
                            </div>
                        </td>
                    </tr>
