<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MoreButtonList.aspx.cs" Inherits="AdminLTE.Page.MoreButtonList" %>
...
<body>
    ...
    <script>
        $(function () {
            ...
            setTimeout(getJsonData("GetDateList","/Page/MoreButtonList.aspx"), 50);
        })
        //获取数据后，重写一些方法
